...
( 
	...
	Client_gender        char(18)  NULL ,
	Client_birthday      datetime  NULL 
)
go
...
( 
	...
	Ingredient_measurement char(18)  NULL 
)
go
...
exec sp_bindrule 'Paym', 'Purchase.Payment_sum'
go
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="0003bd3e", PARENT_OWNER="", PARENT_TABLE="Purchase"
    CHILD_OWNER="", CHILD_TABLE="Dish_in_order"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_59", FK_COLUMNS="Purchase_id""Client_id" */
    IF EXISTS (
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00040f54", PARENT_OWNER="", PARENT_TABLE="Purchase"
    CHILD_OWNER="", CHILD_TABLE="Dish_in_order"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_59", FK_COLUMNS="Purchase_id""Client_id" */
  IF
